...
<Note>
  **Prerequisites:** Before using this SOP, ensure you've completed [Team Onboarding](./onboarding) and reviewed [SPIN Qualification Scripts](./spinabt) for lead qualification procedures.
</Note>

## 🔗 Related SOPs
- **[SPIN Qualification Scripts](./spinabt)** - Lead qualification before discovery calls
- **[Calendly Procedures](./calendly-procedures)** - Detailed Calendly management
- **[Payment Handling](./payment-handling)** - Post-call payment processing
- **[Security Procedures](./security)** - Data protection during calls
