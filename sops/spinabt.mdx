...
<Note>
  **Prerequisites:** Complete [Team Onboarding](./onboarding) and review [Security Procedures](./security) for client data handling during qualification calls.
</Note>

## 🔗 Related SOPs
- **[Call Handling Procedures](./call-handling)** - Post-qualification discovery call management
- **[Calendly Procedures](./calendly-procedures)** - Booking and managing qualified appointments
- **[Payment Handling](./payment-handling)** - Processing payments from qualified leads
- **[Security Procedures](./security)** - Data protection during qualification calls

## 🎯 SPIN Methodology Overview

This SOP provides complete scripts using the SPIN (Situation, Problem, Implication, Need) methodology for qualifying leads before discovery calls.
